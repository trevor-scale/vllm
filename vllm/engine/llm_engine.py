...
from vllm.guided_decoding.outlines_regex import (
    get_outlines_decoding_function, get_outlines_model)
...
class LLMEngine:
    ...
    def __init__(
        ...
        self.outlines_model = get_outlines_model(self.tokenizer)
    ...
    def add_request(
        ...
        seq_group = SequenceGroup(
            request_id, [seq], sampling_params, arrival_time, decoding_function
        )
    ...
    def _schedule(
        self,
    ) -> Tuple[List[SequenceGroupMetadata], SchedulerOutputs, Optional[List[RequestOutput]]]:
        ...
        for parent in parent_seqs:
            ...
            for child_sample in child_samples[:-1]:
                ...
                child.append_token_id(
                    child_sample.output_token, child_sample.logprobs, seq_group.decoding_function
                )
    ...
    def _log_system_stats(
        ...
        self.num_generation_tokens = [
            (t, n) for t, n in self.num_generation_tokens if now - t < _LOGGING_INTERVAL_SEC
        ]
